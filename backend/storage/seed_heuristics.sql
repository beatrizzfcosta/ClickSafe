...
INSERT OR IGNORE INTO heuristics (code, name, category, description, default_severity, default_weight) VALUES
-- Domain Heuristics
...
('DOMAIN_REVERSE_LOOKUP_FAIL', 'Falha em Reverse Lookup', 'DOMAIN', 'Verifica se o reverse DNS lookup falha', 'LOW', 0.12),
...
('PATH_COMPLEXITY_HIGH', 'Alta Complexidade do Caminho', 'PATH', 'Avalia a complexidade do caminho da URL', 'LOW', 0.10),
...
('PATH_FAKE_FILENAME', 'Nome de Arquivo Falso', 'PATH', 'Detecta nomes de arquivo que tentam enganar o usuário', 'MEDIUM', 0.18),
('PATH_DOUBLE_EXTENSION', 'Dupla Extensão', 'PATH', 'Identifica arquivos com dupla extensão (ex: .pdf.exe)', 'HIGH', 0.30),
...
('BRAND_IMPERSONATION', 'Imitação de Marca', 'GENERAL', 'Detecta tentativas de imitar marcas conhecidas', 'HIGH', 0.30);
